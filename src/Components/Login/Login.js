...
const storeAuthToken = () => {
  ...
  return (
    <div className="purchase"><Navbar></Navbar>
        ...
        <div className="col-sm-12">
          {!newUser ? (
            <form
              ...
              className='login-form shadow rounded text-left p-5'
            >

              
              <h4 align="center" className='font-weight-bold text-secondary mb-4'>Login with your account</h4>
<div className="row">
              <div className="col-md-7">
              <div className='customUser'>

<div className='form-group' controlId='formEmail'>
  <input className="form-control login-formBtn"
...
<div className="form-group" controlId='formPassword'>
  <input className="form-control login-formBtn" onBlur={handleBlur} name='password' type='password' placeholder='Password' ref={register({ required: true })} />
  {errors.password && (
...
<div className="form-group">
  <button className="btn btnLogin" style={{ width: '100%' }} variant='warning'  type='submit' >Login</button>
</div>
...
<div className='form-group col' id='formForget' className='text-center mt-3'>
  ...
  <span style={{ cursor: 'pointer', color: 'darkgray' }} onClick={() => SetNewUSer(true)} >Create an account</span>
            ...
            <form
              ...
              className='login-form shadow rounded text-left p-5'
            >
              <h4 align="center" className='font-weight-bold mb-4'>Create an Account</h4>
...
<div className="form-group" controlId='formFirstName'>
  <input className="form-control login-formBtn" onBlur={handleBlur} name='name'  type='text' placeholder='Name'  ref={register({ required: true })} />
  {errors.email && (
...
<div className="form-group" controlId='formEmail'>
  <input className="form-control login-formBtn" onBlur={handleBlur} name='email' type='email' placeholder='Email' ref={register({ required: true })} />
  {errors.email && (
    <span className='error'>Email is required</span>
  )}
</div>
...
<div className="form-group" controlId='formPassword'>
  <input className="form-control login-formBtn" onBlur={handleBlur} name='password' type='password' placeholder='Password' ref={register({ required: true, minLength: 6 })} />
  {errors.password && (
...
<div className="form-group" controlId='formConfirmPassword'>
  <input className="form-control login-formBtn"  onBlur={handleBlur} name='confirmPassword' type='password' placeholder='Confirm Password'
    ref={register({
...
<div className="form-group">
  <button className="btn btnLogin w-100" variant='primary' type='submit' >  Sign Up </button>
